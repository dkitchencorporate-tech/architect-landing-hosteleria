      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="bg-[#111] border border-gray-800 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="shrink-0 relative">
            <div className="w-32 h-32 md:w-40 md:h-40 bg-black border-4 border-[#FF4500]/50 rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(255,69,0,0.3)] animate-pulse">
              <span className="text-6xl md:text-7xl filter grayscale brightness-200">🤖</span>
            </div>
