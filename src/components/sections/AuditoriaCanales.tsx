      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8">
        ...
        <div className="bg-[#FDFCF8] rounded-3xl border border-gray-100 p-8 md:p-12 space-y-6">
          <div className="flex items-start gap-4">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-100 text-[#FF4500] shrink-0 text-lg font-bold mt-1">1</span>
          ...
          <div className="flex items-start gap-4">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-100 text-[#FF4500] shrink-0 text-lg font-bold mt-1">2</span>
            <p className="text-gray-700 text-lg">
              Te entregamos un informe con cada brecha cuantificada — no genérico, con datos de tu propio negocio.
            </p>
          </div>
          <div className="flex items-start gap-4">
            <span className="flex items-center justify-center w-8 h-8 rounded-full bg-orange-100 text-[#FF4500] shrink-0 text-lg font-bold mt-1">3</span>
            <p className="text-gray-700 text-lg">
