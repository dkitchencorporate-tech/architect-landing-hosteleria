    ...
    <section className="bg-white py-20 border-t border-gray-100">
      <div className="max-w-4xl mx-auto px-6 sm:px-8">
        <div className="bg-[#FDFCF8] rounded-3xl p-8 sm:p-12 border border-gray-200 shadow-xl relative overflow-hidden flex flex-col md:flex-row items-center gap-10">
          ...
          {/* Foto del Fundador (Placeholder o real) */}
          <div className="w-40 h-40 shrink-0 relative">
            <div className="w-full h-full rounded-full border-4 border-white shadow-xl overflow-hidden bg-gray-200">
              {/* Aquí irá tu foto real, por ahora un placeholder elegante */}
              <img 
                src="https://images.unsplash.com/photo-1556157382-97eda2d62296?w=400&q=80" 
                alt="Fundador de Architect.Sys" 
          ...
          <div className="text-center md:text-left flex-grow">
            <h3 className="text-2xl font-black text-gray-900 mb-2">Un mensaje honesto del fundador</h3>
            <p className="text-gray-700 font-medium text-lg mb-6 leading-relaxed text-pretty">
              "Soy <strong className="text-gray-900">Klarx</strong>, Partner Oficial de Kommo desde 2025, y llevo años cruzando el mundo de la hostelería y la tecnología. 
              He visto a decenas de hosteleros perder dinero pagando comisiones abusivas y comprando webs inútiles. 
              Construí este sistema porque creo que tú mereces tener el control absoluto de tu negocio digital."
            </p>
            
            <div className="flex flex-col sm:flex-row items-center gap-4">
              <a 
                href="https://wa.me/34611499674?text=Hola%20Klarx,%20vengo%20de%20la%20web." 
              ...
              <span className="text-gray-500 font-medium text-sm hidden sm:inline-block">Contesto en menos de 1 hora.</span>
            </div>
          </div>
        </div>
      </div>
