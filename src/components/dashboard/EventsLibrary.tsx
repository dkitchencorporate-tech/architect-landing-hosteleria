      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-zinc-400 text-sm max-w-2xl">
            Formatos ya desarrollados y probados. Abre el dossier operativo de cualquiera y solicítalo cuando quieras montarlo.
          </p>
        </div>
      </div>
        ...
        {eventsList.map((event) => {
          ...
          return (
            <div
              ...
              className={`relative bg-zinc-900/50 backdrop-blur-md border border-white/10 rounded-xl p-6 cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:border-orange-500/50 hover:shadow-[0_0_20px_rgba(249,115,22,0.15)]
            ...
            >
              ...
              <div className="flex flex-col h-full">
                <span className="text-xs font-bold uppercase tracking-wider mb-2 text-orange-500">{event.category}</span>
                ...
                <div className="flex items-center justify-between text-xs pt-4 border-t border-white/10">
                  ...
                  <span className={isRequested ? 'text-green-500 font-medium' : 'text-orange-500 font-medium'}>
                    {isRequested ? 'Ver Estado' : 'Ver Dossier →'}
                  </span>
                </div>
              </div>
            </div>
