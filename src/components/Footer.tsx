        ...
        <div className="flex flex-col items-center md:items-end gap-6">
          <div className="flex gap-4">
            <a
              ...
              aria-label="WhatsApp"
              className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#FF4500] hover:-translate-y-1 transition-all"
            >
          ...
          <nav className="flex flex-wrap justify-center gap-x-4 gap-y-2 text-sm text-gray-500 font-medium">
            ...
            <span>|</span>
            <Link href="/terms" className="hover:text-[#FF4500] transition-colors">Términos</Link>
          </nav>
        </div>
      </div>
    </footer>
