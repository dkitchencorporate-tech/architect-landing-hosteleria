      ...
      <section className="py-16 md:py-24 bg-[#FDFCF8]">
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative mb-16">
            <div className="hidden md:block absolute top-12 left-[15%] right-[15%] h-1 bg-gradient-to-r from-gray-200 via-[#D9531E] to-gray-900 z-0 opacity-50"></div>
            <div className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-white border-4 border-[#D9531E] rounded-full flex items-center justify-center text-3xl font-black text-[#D9531E] shadow-lg mb-6 group-hover:scale-110 group-hover:bg-[#D9531E] group-hover:text-white transition-all duration-500">1</div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center group">
              <div className="w-24 h-24 bg-[#D9531E] rounded-full flex items-center justify-center text-3xl font-black text-white shadow-lg mb-6 group-hover:scale-110 transition-all duration-500 shadow-orange-500/40">2</div>
      ...
      <section className="py-16 md:py-20 bg-white border-y border-gray-100">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/qr"
              className="group rounded-2xl border-2 border-gray-100 p-8 text-center hover:border-[#D9531E] hover:shadow-xl transition-all"
            >
              <div className="text-3xl mb-3">📱</div>
              <h3 className="text-xl font-bold mb-2 group-hover:text-[#D9531E] transition-colors">QR Menú</h3>
            ...
            >
              <div className="text-3xl mb-3">🎉</div>
              <h3 className="text-xl font-bold mb-2 group-hover:text-[#D9531E] transition-colors">Experience</h3>
            ...
            >
              <div className="text-3xl mb-3">🔎</div>
              <h3 className="text-xl font-bold mb-2 group-hover:text-[#D9531E] transition-colors">Auditoría</h3>
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 group-hover:text-[#D9531E] transition-colors">Base Operativa</h3>
            ...
            >
              <div className="text-3xl mb-3">🔥</div>
              <h3 className="text-xl font-bold mb-2 group-hover:text-[#D9531E] transition-colors">Dark Kitchen</h3>
