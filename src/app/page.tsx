      ...
      <nav className="fixed top-0 w-full z-[100] bg-black/90 backdrop-blur-md border-b border-white/10 shadow-xl transition-all">
        <div className="flex flex-col md:flex-row justify-between items-center py-3 md:py-4 px-4 md:px-8 max-w-7xl mx-auto gap-3 md:gap-0">
          <div className="flex justify-between items-center w-full md:w-auto">
            ...
            <a href="https://wa.me/34622652659?text=Hola,%20quiero%20solicitar%20la%20Auditoría%20Gratuita." className="md:hidden inline-flex bg-[#FF4500] text-white px-4 py-2 rounded-full font-bold text-[10px] sm:text-xs hover:bg-orange-600 transition-all shadow-lg shrink-0 ml-2">
              Auditoría Gratuita
            </a>
          </div>
          ...
          <a href="https://wa.me/34622652659?text=Hola,%20quiero%20solicitar%20la%20Auditoría%20Gratuita." className="hidden md:inline-flex bg-[#FF4500] text-white px-6 py-2.5 rounded-full font-bold text-sm hover:bg-orange-600 transition-all shadow-lg hover:shadow-orange-500/50 hover:-translate-y-1 items-center gap-2">
      ...
      <section className="py-12 bg-gray-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-8 flex flex-col md:flex-row items-center gap-8 relative z-10">
           ...
           <div>
              ...
              <p className="text-gray-300 text-lg">En DKitchen protegemos la privacidad operativa de nuestros clientes. No publicamos facturaciones ajenas para captar curiosos. En su lugar, tienes una **Demo en Vivo**: escanea un QR, navega una carta PWA premium y haz un pedido real de principio a fin. Juzga nuestra tecnología por ti mismo.</p>
           </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8 flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <div className="text-gray-400 text-sm font-medium">
              © {new Date().getFullYear()} DKitchen. Tu equipo para llenar tu restaurante.
            </div>
          </div>
          
          <div className="flex flex-col items-center md:items-end gap-6">
            <div className="flex gap-4">
              <a href="https://wa.me/34622652659" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-[#FF4500] hover:-translate-y-1 transition-all">
