...
export const UI_TRANSLATIONS: any = {
  es: {
    ...
    view_order: "Ver Comanda", empty_cart: "Tu bandeja está vacía.", send_order: "Confirmar Comanda a Cocina",
    ...
    sales_btn_web: "Ver Ecosistema Completo", select_design: "Seleccionar Tipo de Negocio (Demostración)",
    ...
    send_to_kitchen: "🚀 Enviar Pedido a Cocina",
  ...
  en: {
    ...
    view_order: "View Order", empty_cart: "Your tray is empty.", send_order: "Confirm Order to Kitchen",
    ...
    sales_btn_web: "View Full Ecosystem", select_design: "Select Business Type (Demo)",
  ...
  fr: {
    ...
    view_order: "Voir Commande", empty_cart: "Votre plateau est vide.", send_order: "Confirmer Commande en Cuisine",
    ...
    sales_btn_web: "Voir l'Écosystème Complet", select_design: "Sélectionner Type d'Affaires (Démo)",
